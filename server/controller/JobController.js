...
const create = async (req, res) => {
  try {
    const jobs = await req.context.models.jobs.create({
      ...
      jobs_end_date: new Date(),
      jobs_upto_salary: parseInt(fields[2].value),
      job_upto_experience: parseInt(fields[3].value),
      jobs_description: fields[4].value,
      jobs_primary_skill: fields[5].value,
      jobs_secondary_skill: fields[6].value,
      jobs_industry_type: fields[7].value,
      jobs_working_type: fields[8].value,
      jobs_publish: fields[9].value,
      jobs_remotely: fields[10].value,
      jobs_spec_education: fields[11].value,
      jobs_benefit: fields[12].value,
      jobs_specification: fields[13].value,
      jobs_status: fields[14].value,
      jobs_location: fields[15].value,
      jobs_city: fields[16].value,
      jobs_user_id: parseInt(fields[17].value),
      jobs_client_id: parseInt(fields[18].value),
